...
module.exports = {
  // extends를 빈 배열로 설정하여 @commitlint/config-conventional의 영향을 받지 않도록 합니다.
  extends: [],

  // 커스텀 파서 프리셋을 정의합니다.
  parserPreset: {
    parserOpts: {
      // 이전에 정의했던 당신의 커스텀 headerPattern을 그대로 사용합니다.
      // 이 패턴은 [type][scope]: subject 형식을 정확히 파싱합니다.
      headerPattern:
